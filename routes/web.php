...
Route::group(['prefix' => 'hmall-products'], function () {
    Route::get('/{uniqlo_product_code}', 'HmallProductController@show')->name('uniqlo-hmall-products.show');
    Route::get('/{uniqlo_product_code}/style-hints', 'StyleHintController@show')->name('style-hints.show');
});
...
Route::group(['prefix' => 'lists'], function () {
    ...
    Route::get('/top-wearing', 'ListController@getTopWearing')->name('lists.top-wearing');
