        ...
        <div class="sixteen wide tablet eleven wide computer column">
            ...
            <div class="ts basic segment">
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                        非常歡迎您光臨「UQ 搜尋」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
                    </p>
                </div>

                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">一、隱私權保護政策的適用範圍</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                ...
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">二、個人資料的蒐集、處理及利用方式</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                ...
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">四、網站對外的相關連結</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                ...
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">五、與第三人共用個人資料之政策</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                ...
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">六、Cookie 之使用</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
                ...
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <div class="header">七、隱私權保護政策之修正</div>
                </div>
                <div class="ts large padded basic horizontally fitted secondary attached message">
                    <p>
