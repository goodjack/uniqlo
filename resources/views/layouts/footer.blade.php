<x-section grid="stackable" inverted>
    <div class="eleven wide column">
        ...
        <div class="ts large compact inverted basic faded message">
            <p>
                UQ 搜尋是一個社群作品，由
                <a class="ts link button" href="https://twitter.com/littlegoodjack" target="_blank" rel="nofollow noopener"
                    aria-label="Twitter @littlegoodjack">
                    小克
                </a>
                製作。
            </p>
